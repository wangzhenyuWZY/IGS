(function (a) {
  ...
  function r(b) {
    0 !== a(b).find(".nav-tabs").length && a(b).outerFind('section[id^="tabs"]').each(function () {
      var b = a(this).attr("id"), d = a(this).find(".nav-tabs .nav-item"), e = a(this).find(".tab-pane");
  ...
  a.fn.footerReveal = function () {
    ...
    var c = a(this), d = c.prev(), e = a(window), h = !!document.documentMode;
    b();
  ...
  a(function () {
    ...
    var e, h, n = 0, g = null, l = !a.isMobile();
    a(window).scroll(function () {
      h && clearTimeout(h);
      var b = a(window).scrollTop(), c = b <= n || l;
      n = b;
      if (g) {
    ...
    a(".cols-same-height .mbr-figure").each(function () {
      ...
      var c = a(this), d = c.children("img"), e = c.parent(), h = d[0].width, f = d[0].height;
      d.one("load", function () {
        h = d[0].width;
        f = d[0].height;
        b()
  ...
  if (!f) {
    ...
    a(document).ready(function () {
      if (!a.isMobile() && a("input[name=animation]").length) {
        ...
        }).addClass("hidden animated"), e = a(window);
        e.on("scroll resize", function () {
          var e = document.documentElement.scrollTop || document.body.scrollTop, f = e + window.innerHeight - 50;
          a.each(d, function () {
            var d = a(this), l = d[0], k = l.offsetHeight, l = c(l);
  ...
  a(document).ready(function () {
    if (!f) {
      var b = function (b) {
        var d = a(b).parents("section").find("iframe")[0], e = a(d).attr("src");
  ...
  if (!f && !a.isMobile()) {
    var m = a("section.menu"), u = a(window).width();
...
!function () {
  ...
  if (!document.getElementById("top-1")) {
    ...
    a.innerHTML = '<a href="https://mobirise.in">Mobirise</a> Mobirise v5.2.0';
